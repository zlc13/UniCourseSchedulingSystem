jQuery(document).ready(function(e){
    function t(e,t,n){
        var i=d(e.eventsWrapper),r=Number(e.timelineWrapper.css("width").replace("px",""));
