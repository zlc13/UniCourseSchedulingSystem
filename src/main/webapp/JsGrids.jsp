...
<%--      <!--.main-menu(class="#{menuColor} #{menuOpenType}", class=(menuShadow == true ? 'menu-shadow' : ''))-->--%>
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
              ...
              <li class=" nav-item"><a href="grids"><i class="ft-droplet"></i><span data-i18n="" class="menu-title">教室信息</span></a>
              </li>
  ...
  <div class="col-sm-12">
    <form action="SearchJs" method="get">
      <input type="text" placeholder="Class Name" name="js_name" >
              ...
              <table id="yourcourse" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                  ...
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='2'&& Js.status=='true'  }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='3' && Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='4' && Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='5' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='6' && Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='1'&& Js.day=='7' && Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='2' && Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='4'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='5' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='6' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='2'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='2' && Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='3'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='5'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='6'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='3'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='1'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='2'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='5'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='6'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='4'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='2'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='4'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='5'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='6' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='5'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='2' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='5' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='6' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='6'&& Js.day=='7' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='2' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='5' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='6' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='7'&& Js.day=='7' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='2' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='4'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='5' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='6' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='8'&& Js.day=='7' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='2' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='5'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='6' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='9'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='1'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='2'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='5'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='6'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='10'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='1' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='2'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='3' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='4' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='5' && Js.status=='true'}">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='6'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${jslist}" var="Js">
                    <c:if test="${Js.time =='11'&& Js.day=='7'&& Js.status=='true' }">
                      <td>true</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
