            ...
            <div class="card">
              <div class="card-body">
                ...
                <form  class="site-form" action="AddJsSuccess" method="get">
                    ...
                    <label >教室编号</label>
                    <input type="text" name="js_nb" class="form-control"  value=""/>
                  </div>
                  <div class="form-group">
                    <label >教室名</label>
                    <input type="text" name="js_name" class="form-control" placeholder="" value="" >
                  </div>
                    <div class="form-group">
                        <label >教室类别</label>
                        <input type="text" name="js_pt" class="form-control" placeholder="" value="" >
                    </div>
                    <div class="form-group">
                        <label >教室规模</label>
                        <input type="text" name="js_se" class="form-control" placeholder="" value="">
                    </div>
