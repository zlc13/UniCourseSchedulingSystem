    ...
    <div class="sidebar-content">
      <div class="nav-container">
        <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="userprofile"><i class="ft-calendar"></i><span data-i18n="" class="menu-title">个人资料修改</span></a>
          </li>
...
<div class="row">
  <div class="col-sm-12">
    <div class="content-header">考试时间线</div>
    <p class="content-sub-header">你可以查看你的考试时间表.</p>
  </div>
</div>
<div class="card">
      ...
      <section class="cd-horizontal-timeline">
        <div class="timeline">
          <div class="events-wrapper">
            <div class="events">
              <ol>
                <li><a data-date="16/01/2014" class="selected">12.16</a></li>
                <li><a data-date="28/02/2014">12.18</a></li>
                <li><a data-date="20/04/2014">12.21</a></li>
                <li><a data-date="20/05/2014">12.24</a></li>
                <li><a data-date="09/07/2014">12.26</a></li>
        ...
        <div class="events-content">
          <ol>
            <li class="selected" data-date="16/01/2014">
              <h2 class="text-bold-500">考试科目：</h2>
              <h4 class="text-bold-500 mb-2"></h4>
              <p>
...
<!--Horizontal Timeline Starts-->
        ...
        <footer class="footer footer-static footer-light">
          <p class="clearfix text-muted text-sm-center px-2"><span>Copyright  &copy; 我们团队 <a href="javascript:;" id="pixinventLink" target="_blank" class="text-bold-800 primary darken-2">PIXINVENT </a> </span></p>
        </footer>
        <!-- End : Footer-->
...
<!-- BEGIN PAGE LEVEL JS-->
<!-- END PAGE LEVEL JS-->
<script src="js/horizontal-timeline.min.js" type="text/javascript"></script>
