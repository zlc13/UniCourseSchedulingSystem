    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <p class="card-text">你可以在这个页面查看到你所在的班级与人数
          </p>
        </div>
        <div class="card-content ">
          <div class="card-body table-responsive" >
            <table id="datatable-button" class="table table-striped table-bordered add-rows">
              <thead>
              <tr>
                <th>学号</th>
                <th>姓名</th>
...
<!--/ Search API (regular expressions) table -->
        ...
        <footer class="footer footer-static footer-light">
          <p class="clearfix text-muted text-sm-center px-2"><span>Copyright  &copy; 2021 <a href="javascript:;" id="pixinventLink" target="_blank" class="text-bold-800 primary darken-2">我们团队 </a>, 所有. </span></p>
        </footer>
        <!-- End : Footer-->
