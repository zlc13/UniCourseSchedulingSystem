          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
                <form  class="site-form" action="successbjks" method="get">
                    <div class="form-group">
                    <label >教室编号</label>
                    <input type="text" name="js_nb" class="form-control"  value="${Bjksdata.js_nb}"  readonly="readonly"/>
                  </div>
                  <div class="form-group">
                    <label >教室名称</label>
                    <input type="text" name="js_name" class="form-control" placeholder="" value="${Bjksdata.js_name}" readonly="readonly">
                  </div>
                    <div class="form-group">
                        <label >日期</label>
                        <input type="text" name="day" class="form-control" placeholder="" value="${Bjksdata.day}" readonly="readonly">
                    </div>
                    <div class="form-group">
                        <label >课节</label>
                        <input type="text" name="time" class="form-control" placeholder="" value="${Bjksdata.time}" readonly="readonly">
                    </div>
                    <div class="form-group">
                        <label >班级课时编号</label>
                    ...
                    <div class="form-group">
                        <label >教师课时编号</label>
                        <input type="text" name="trjs_nb" class="form-control" placeholder="" value="">
                    </div>
                    <div class="form-group">
                        <label >班级编号</label>
                    ...
                    <div class="form-group">
                        <label >班级名</label>
                        <input type="text" name="bj_name" class="form-control" placeholder="" value="">
                    </div>
                    <div class="form-group">
                        <label >教师编号</label>
