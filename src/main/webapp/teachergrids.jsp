...
<html lang="en" class="loading">
  ...
  <%
     ...
     List<Bjks> bjksList = (List<Bjks>) request.getAttribute("TrjsList");
  ...
  <div class="wrapper">
    ...
    <div data-active-color="black" data-background-color="white" data-image="" class="app-sidebar">
      ...
      <div class="sidebar-header">
        <div class="logo clearfix"><a href="index1.jsp" class="logo-text float-left">
            ...
            <div class="table-responsive">
              ...
              <table id="yourcourse" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='1' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                  ...
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='2' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='3' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='4' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='5' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='6' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='1'&& TrJs.day=='7' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='1' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='2' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='3' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='4' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='5' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='6' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='2'&& TrJs.day=='7' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='1' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}&nbsp;</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='2' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='3' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='4' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='5' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='6' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='3'&& TrJs.day=='7' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='1' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='2' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='3' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='4' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='5' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='6' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='4'&& TrJs.day=='7' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='1' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='2' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='3' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='4' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='5' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='6' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='5'&& TrJs.day=='7' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='1' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='2' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='3' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='4' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='5' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='6' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='6'&& TrJs.day=='7' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='1' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='2' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='3' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='4' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='5' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='6' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='7'&& TrJs.day=='7' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='1' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='2' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='3' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='4' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='5' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='6' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='8'&& TrJs.day=='7' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='1' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='2' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='3' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='4' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='5' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='6' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='9'&& TrJs.day=='7' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='1' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='2' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='3' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='4' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='5' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='6' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='10'&& TrJs.day=='7' }">
                      <td><code>${TrJs.c_na}&nbsp;${TrJs.bj_name}</code></td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                ...
                <tr>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='1' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='2' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='3' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='4' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='5' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='6' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                  ...
                  <c:set var="index"  value='0'/>
                  <c:forEach items="${TrjsList}" var="TrJs">
                    <c:if test="${TrJs.time =='11'&& TrJs.day=='7' }">
                      <td>${TrJs.c_na}&nbsp;${TrJs.bj_name}</td>
                      <c:set var="index"  value='1'/>
                    </c:if>
                  </c:forEach>
                          ...
                          <div class="collection border-none">
                            <div class="media mb-1"><a href="TeacherSignin.jsp"><img  alt="96x96" src="images/SwitchAccount.png" ></a>
                              <div class="media-body">
                                ...
                                <p class="text-muted font-small-3" href="">退出</p>
                              </div>
                            </div>
