...
<head>
    ...
    <link rel="stylesheet" href="/css/main copy1.css">
            ...
            <div class="col-12">
                <div class="sign__content">
                    ...
                    <form action="/adminlogin" class="sign__form" method="post">
                        <a href="adminSignin.jsp" class="sign__logo">
                            <img src="${pageContext.request.contextPath}/picture/xmlg.png" alt="">
                        </a>

                        <div class="sign__group">
                            <input type="text" class="sign__input" placeholder="账号" name="admin_num">
                        </div>

                        <div class="sign__group">
                            <input type="password" class="sign__input" placeholder="密码" name="admin_password">
                        </div>
